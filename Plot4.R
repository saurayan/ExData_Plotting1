...
# Plot#4 Four Quadrant Graph
png("plot4.png", width=480, height=480)
par(mfrow=c(2,2))
with(tbl_sub, plot(datetime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
with(tbl_sub, plot(datetime, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
with(tbl_sub, plot(datetime, Sub_metering_1, type="l", xlab="", ylab="Energy sub metering"))
...
with(tbl_sub, plot(datetime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()
